...
draw_sprite_ext(textbox_sprite, textbox_image, spritebox_x + border*2.25, textbox_y, sprite_get_width(speaking_sprite)/textbox_sprite_width, sprite_get_height(speaking_sprite)/textbox_sprite_height, 0, c_gray, 1);
//Drawing the speaking sprite
draw_sprite_ext(speaking_sprite, spritebox_image, spritebox_x - spritebox_border/2, spritebox_y - spritebox_border, spritebox_size/textbox_sprite_width, spritebox_size/textbox_sprite_height, 0, c_white, 1)
}
//Draw the responses
